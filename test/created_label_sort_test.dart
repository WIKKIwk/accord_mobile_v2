...
void main() {
  test(
    'compareCreatedLabelsDesc prefers parsed timestamps over document ids',
    () {
      final labels = <String>[
        'MAT-PRE-0001',
  ...
  test('createdLabelIsAfter handles date-only and full timestamps', () {
    expect(createdLabelIsAfter('2026-03-21T10:00:00Z', '2026-03-21'), isTrue);
    expect(createdLabelIsAfter('2026-03-20', '2026-03-21T10:00:00Z'), isFalse);
  });
}
