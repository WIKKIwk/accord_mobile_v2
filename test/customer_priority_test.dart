import 'package:accord_mobile_v2/src/core/customer/customer_priority.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  test(
    'compareCustomerNamesForDefault pushes Saidamin after other customers',
    () {
      expect(
  ...
  test(
    'preferPrimaryCustomer falls back to Saidamin when it is the only one',
    () {
      final picked = preferPrimaryCustomer([
        'Saidamin',
      ], customerName: (item) => item);
