...
void main() {
  ...
  test('returned paint draft restores named fields, tab and image', () async {
    ...
    draft.addNamedField('rasxot:Oq', 'Pantone Blue');
    ...
    expect(restored.fieldLabelsFor('rasxot:Oq', const []).last, 'Pantone Blue');
