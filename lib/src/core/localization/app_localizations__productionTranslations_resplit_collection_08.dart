...
const _app_localizations_declarations__productionTranslations_resplitPart08 = {
  ...
  'worker.merge_state.lineage': {
    ...
    'en': 'Roll sequence: {lineage}',
    'ru': 'Последовательность рулонов: {lineage}',
  },
  'worker.merge_state.partial_rolls': {
    'uz': 'Faol o‘ramlar: {rolls} ta · Manba: {sources} ta rulon',
    'en': 'Active partial rolls: {rolls} · sources: {sources} rolls',
    'ru': 'Активные рулоны: {rolls} · источники: {sources} рул.',
  },
