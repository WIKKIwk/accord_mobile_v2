...
class CalculateOrderProductionOptions {
  ...
  factory CalculateOrderProductionOptions.fromJson(Map<String, dynamic> json) =>
      CalculateOrderProductionOptions(
        printMethod: _calculateText(json['print_method']),
        coldGlue: json['cold_glue'] == true,
        diameterMm: _calculateOptionalNumber(json['diameter_mm']),
      );
...
class CalculateOrderTemplate {
  ...
  factory CalculateOrderTemplate.fromJson(Map<String, dynamic> json) {
    ...
    return CalculateOrderTemplate(
      productionOptions: json['production_options'] is Map
          ? CalculateOrderProductionOptions.fromJson(
              (json['production_options'] as Map).cast<String, dynamic>())
          : null,
  ...
  final String id;
  final CalculateOrderProductionOptions? productionOptions;
  final String code;
  final String name;
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      if (productionOptions != null)
        'production_options': productionOptions!.toJson(),
  ...
  CalculateOrderTemplate copyWith({
    CalculateOrderProductionOptions? productionOptions,
    String? id,
    String? code,
    String? name,
    DateTime? savedAt,
    ...
    return CalculateOrderTemplate(
      productionOptions: productionOptions ?? this.productionOptions,
      id: id ?? this.id,
      code: code ?? this.code,
      name: name ?? this.name,
...
CalculateOrderTemplate _testModeUpsertCalculateOrderTemplate(
  ...
  final saved = CalculateOrderTemplate(
    productionOptions: template.productionOptions,
    id: id,
    code: code,
    name: template.name,
