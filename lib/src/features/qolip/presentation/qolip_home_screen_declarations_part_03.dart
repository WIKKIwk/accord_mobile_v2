...
class _QolipGridTable extends StatefulWidget {
  ...
  @override
  State<_QolipGridTable> createState() => _QolipGridTableState();
}

class _QolipGridTableState extends State<_QolipGridTable> {
    ...
    return Material(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            // Pinned row header numbers (stays fixed at the left wall)
            GestureDetector(
            ...
            // Horizontally scrollable grid columns and cells
            Expanded(
              child: SingleChildScrollView(
                key: const ValueKey<String>('qolip-grid-horizontal-scroll'),
                      ...
                      children: [
                        for (final letter in widget.letters)
                          Padding(
                            ...
                            child: _GridHeaderCell(
                              key: ValueKey<String>('qolip-col-header-$letter'),
                              label: letter,
                              isColumn: true,
                            ),
                          ),
