  ...
  void _save() {
    ...
    Navigator.of(context).pop(
      ProductionMapNode(
        ...
        apparatusId: widget.node.apparatusId,
  ...
  void _save() {
    ...
    Navigator.of(context).pop(
      ProductionMapNode(
        ...
        alternativeAssignedApparatusId:
            widget.node.alternativeAssignedApparatusId,
        rezkaKadrCount: widget.node.rezkaKadrCount,
        rezkaLabelLength: widget.node.rezkaLabelLength,
        rezkaFrameGroups: widget.node.rezkaFrameGroups,
        x: widget.node.x,
        y: widget.node.y,
        formula:
