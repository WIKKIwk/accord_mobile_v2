...
Future<void> _showIssuedCode(BuildContext context, String code) async {
  if (code.isEmpty) return;
  await showDialog<void>(
    context: context,
    builder: (dialogContext) => AlertDialog(
      title: Text(dialogContext.l10n.adminText('user.code')),
      content: Column(
      ...
      actions: [
        TextButton(
          ...
          child: Text(MaterialLocalizations.of(dialogContext).copyButtonLabel),
        ),
        TextButton(
                ...
                children: [
                  Expanded(
                    child: SelectableText(
                      code.trim().isEmpty
                          ? context.l10n.adminText('profile.code_not_shown')
                          : code,
